...
const slotAttr = defaultProvider.provideAttributes("div").find((attr) =>
  attr.name === "slot"
)!;
  ...
  globalAttributes: [
    {
      ...
      references: [
        {
          name: "Civet reference",
          url:
            "https://docs.civet.build/en/reference/directives-reference/#classlist",
        },
      ],
    },
  ],
...
export const civetElements = newHTMLDataProvider("civet-elements", {
  version: 1,
  tags: [
    {
      name: "slot",
      ...
      references: [
        {
          name: "Civet reference",
          url:
            "https://docs.civet.build/en/core-concepts/civet-components/#slots",
        },
      ],
      attributes: [
        {
          ...
          references: [
            {
              name: "Civet reference",
              url:
                "https://docs.civet.build/en/core-concepts/civet-components/#named-slots",
            },
          ],
        },
      ],
          ...
          references: [
            {
              name: "Civet reference",
              url:
                "https://docs.civet.build/en/reference/directives-reference/#definevars",
            },
          ],
        },
        {
          name: "hoist",
          description:
            "**Deprecated in Civet >= 0.26.0**\n\nBuilds, optimizes, and bundles your script with the other JavaScript on the page.",
          valueSet: "v",
          references: [
            {
              name: "Civet reference",
              url:
                "https://docs.civet.build/en/core-concepts/civet-components/#using-hoisted-scripts",
            },
          ],
        },
        {
          ...
          references: [
            {
              name: "Civet reference",
              url:
                "https://docs.civet.build/en/reference/directives-reference/#isinline",
            },
          ],
        },
        {
          name: "data-civet-rerun",
          description:
          ...
          references: [
            {
              name: "Civet reference",
              url:
                "https://docs.civet.build/en/guides/view-transitions/#script-behavior",
            },
          ],
        },
      ],
    },
    {
      ...
      attributes: [
        ...
        },
        {
          name: "global",
          description:
            "**Deprecated in favor of `is:global` in >= Civet 0.26.0**\n\nOpts-out of automatic CSS scoping, all contents will be available globally.",
          valueSet: "v",
          references: [
            {
              name: "Civet reference",
              url:
                "https://docs.civet.build/en/reference/directives-reference/#isglobal",
            },
          ],
        },
        {
...
export const civetAttributes = newHTMLDataProvider("civet-attributes", {
  version: 1,
  globalAttributes: [
    {
      name: "set:html",
      ...
      references: [
        {
          name: "Civet reference",
          url:
            "https://docs.civet.build/en/reference/directives-reference/#sethtml",
        },
      ],
    },
    {
      ...
      references: [
        {
          name: "Civet reference",
          url:
            "https://docs.civet.build/en/reference/directives-reference/#settext",
        },
      ],
    },
    {
      name: "is:raw",
      description:
        "Instructs the Civet compiler to treat any children of this element as text.",
      valueSet: "v",
      references: [
        {
          name: "Civet reference",
          url:
            "https://docs.civet.build/en/reference/directives-reference/#israw",
        },
      ],
    },
    {
      ...
      description:
        "Specifies an animation to use with this element on page transition.",
      references: [
        {
          name: "Civet reference",
          url:
            "https://docs.civet.build/en/guides/view-transitions/#transition-directives",
        },
      ],
    },
    {
    ...
    },
    {
      ...
      description:
        "Marks this element to be moved to the next page during view transitions.",
      references: [
        {
          name: "Civet reference",
          url:
...
export const civetDirectives = newHTMLDataProvider("civet-directives", {
  version: 1,
  globalAttributes: [
    {
      name: "client:load",
      ...
      references: [
        {
          name: "Civet reference",
          url:
            "https://docs.civet.build/en/reference/directives-reference/#clientload",
        },
      ],
    },
    {
      ...
      references: [
        {
          name: "Civet reference",
          url:
            "https://docs.civet.build/en/reference/directives-reference/#clientidle",
        },
      ],
    },
    {
      ...
      references: [
        {
          name: "Civet reference",
          url:
            "https://docs.civet.build/en/reference/directives-reference/#clientvisible",
        },
      ],
    },
    {
      ...
      references: [
        {
          name: "Civet reference",
          url:
            "https://docs.civet.build/en/reference/directives-reference/#clientmedia",
        },
      ],
    },
    {
      ...
      references: [
        {
          name: "Civet reference",
          url:
            "https://docs.civet.build/en/reference/directives-reference/#clientonly",
        },
      ],
    },
  ],
